...
namespace CupheadStateName
{
	...
	const std::string Player_AfterGetHitAir = "Player_AfterGetHitAir";
}
...
namespace FlowerBossAniName
{
	...
	const std::string FlowerP2_Intro1 = "FlowerP2_Intro1";
	const std::string FlowerP2_Intro2 = "FlowerP2_Intro2";
	const std::string FlowerP2_Intro3 = "FlowerP2_Intro3";
	const std::string FlowerP2_Intro4 = "FlowerP2_Intro4";
...
namespace PirateBossAniName
{
	...
	const std::string Ship_Phase2_Transform_Idle = "Ship_Phase2_Transform_Idle";
	...
	const std::string Barrel_Drop_Begin = "Barrel_Drop_Begin";
...
namespace GColliderScale
{
	...
	const float4 VineAttack_ColScale = float4(64.0f, 200.0f, 1.0f);
	...
	const float4 PirateBoss_Phase1_ColScale = float4(150.0f, 220.0f, 1.0f);
...
namespace GColliderPosInfo
{
	...
	const float4 PirateBoss_Phase1_RelPos = float4(-180.0f, 510.0f, 0.0f);
...
namespace GColorValue
{
	...
	const float4 InvincibleMulColor = float4(1.0f, 1.0f, 1.0f, 0.5f);
	const float4 InvincibleMulRestoreColor = float4(1.0f, 1.0f, 1.0f, 1.0f);
}
