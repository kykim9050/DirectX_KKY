...
void ACaptainBrineybeardPhase1::CreateAnimation()
{
	...
	ShipRenderer->CreateAnimation(PirateBossAniName::Ship_Phase1_Wince_Begin, "Ship_Phase1_Wince", 0.047f, false, 0, 1);
	ShipRenderer->CreateAnimation(PirateBossAniName::Ship_Phase1_Wince_Idle, "Ship_Phase1_Wince", 0.047f, true, 1, 8);
